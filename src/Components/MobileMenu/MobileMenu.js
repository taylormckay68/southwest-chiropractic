...
export default function MobileMenu(props) {
    return(
        <MenuWrapper open={props.open}>
            <CloseWrapper>
                <CloseIcon onClick={() => props.toggleMenu('menu')}>
            ...
            <LinkWrapper>
                <MainLinkContainer>
                    <MainLink to='/' onClick={() => props.toggleMenu('menu')}>Home</MainLink>    
                </MainLinkContainer>
                <ServicesMenuWrapper>
                    <ServicesHeaderWrapper onClick={() => props.toggleMenu('serviceMenu')}>
                    ...
                    <SubServicesWrapper open={props.serviceMenu}>
                        {serviceData.map((e,i) => {
                            return(
                                <SubService 
                                    key={i} 
                ...
                <MainLinkContainer>
                    <MainLink to='/contact' onClick={() => props.toggleMenu('menu')}>Contact</MainLink>
                </MainLinkContainer>
            </LinkWrapper>
        </MenuWrapper>
    )
