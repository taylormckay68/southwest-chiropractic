...
export default function GetInTouch() {
    return(
        <GetInTouchWrapper className='get-in-touch-wrapper'>
            <GetInTouchHeader className='get-in-touch-header'>GET IN TOUCH</GetInTouchHeader>
            <EmailContact className='email-contact' href="mailto:bradnpetersondc@comcast.net">bradnpetersondc@comcast.net </EmailContact>
            <CallButtonAnchor className='info-call-button-anchor' href="tel:1-801-254-9400">
                <CallButton className='info-call-button'>
